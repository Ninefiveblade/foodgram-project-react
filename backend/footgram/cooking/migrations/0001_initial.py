# Generated by Django 3.0 on 2022-07-05 13:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', colorfield.fields.ColorField(default='#FFFFFF', image_field=None, max_length=7, samples=[('#E26C2D', 'Оранжевый'), ('#228b22', 'Зеленый'), ('#9370d8', 'Лиловый')], unique=True, verbose_name='Код цвета HEX')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='shop_list_user', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь избранных рецептов')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredient', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ingredient_amount', to='cooking.Ingredient', verbose_name='Ингридиент')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ManyToManyField(related_name='favorite_recipe', to='cooking.Recipe', verbose_name='Избранный рецепт')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favotite_list_user', to=settings.AUTH_USER_MODEL, verbose_name='Пользователь избранных рецептов')),
            ],
            options={
